...
public class MessageRabbitMQConfirmConfig implements RabbitTemplate.ConfirmCallback,RabbitTemplate.ReturnsCallback {
     ...
     */
    private MessageLogDO getMessageLogFromDb(String correlationDataId) throws ReflectiveOperationException {
        ...
        return BeanUtils.copyProperties(messageLogVO,MessageLogDO.class);
    }
}
