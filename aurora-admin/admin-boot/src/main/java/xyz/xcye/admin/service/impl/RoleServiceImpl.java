...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public List<RoleVO> queryAllByCondition(Condition<Integer> condition) throws ReflectiveOperationException {
    ...
    public RoleVO queryByUid(int uid) throws ReflectiveOperationException {
        Condition<Integer> condition = Condition.instant(uid, Integer.class, false);
