...
public class RegisterOperateUserExchange {
    ...
    public TopicExchange operateUserExchange() {
        return new TopicExchange(RabbitMQNameConstant.AURORA_SEND_OPERATE_USER_EXCHANGE,true,false);
    }
    ...
    public TopicExchange operateUserDeadLetterExchange() {
        return new TopicExchange(RabbitMQNameConstant.AURORA_SEND_OPERATE_USER_DEAD_LETTER_EXCHANGE,true,false);
    }
}
