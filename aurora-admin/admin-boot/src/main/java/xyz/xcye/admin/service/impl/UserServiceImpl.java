...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<UserVO> queryAllByCondition(Condition<Long> condition) throws ReflectiveOperationException {
    ...
    public UserDO queryByUsernameContainPassword(String username) throws ReflectiveOperationException {
        return BeanUtils.getSingleObjFromList(userDao.queryAllByCondition(Condition.instant(username, Long.class)), UserDO.class);
    }

    @Override
    public UserDO queryByUidContainPassword(long uid) throws ReflectiveOperationException {
        return BeanUtils.getSingleObjFromList(userDao.queryAllByCondition(Condition.instant(uid, Long.class, true)), UserDO.class);
    }
    ...
    private boolean existsRole(String role) throws ReflectiveOperationException {
        ...
        Condition<Integer> condition = Condition.instant(role, Integer.class);
